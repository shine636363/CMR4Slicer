...
# SegmentEditor
#
class SegmentCalc(ScriptedLoadableModule):
  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    import string
    self.parent.title = "Segment Calc"
...
# SegmentEditorWidget
#
class SegmentCalcWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  def __init__(self, parent):
  ...
  def selectParameterNode(self):
    ...
    segmentEditorSingletonTag = "SegmentCalc"
...
class SegmentCalcTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_SegmentCalc1()

  def test_SegmentCalc1(self):
    """Add test here later.
    """
